...
This license applies exclusively to companies or organizations (“the Company”) that have
purchased and maintain an active subscription under the plan:
...
1.2. If the subscription is cancelled, paused, or payment fails, this license becomes void
     and the Company immediately reverts to the restrictions of UPL 1.0.
...
## 3. Mandatory Contribution Requirement

3.1. Any modification to the Software — including fixes, enhancements, optimizations,
     integrations, or functional changes — **must be submitted upstream** to the original project.

3.2. Contributions must be made in good faith and without intentional obfuscation.

3.3. The Company may not maintain private forks with modified versions of the Software
     unless those modifications have already been offered upstream.
...
## 6. After Subscription Termination
